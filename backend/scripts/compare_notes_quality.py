...
def main() -> int:
    ...
    parser.add_argument(
        "--docx",
        default=str(PROJECT_ROOT / "output" / "The_Constitution_Of_India_By_Jhavala_2026-05-28_14-30-12_formatted_v6.docx"),
    )
    parser.add_argument(
        "--out",
        default=str(PROJECT_ROOT / "output" / "notes_quality_report.txt"),
    )
