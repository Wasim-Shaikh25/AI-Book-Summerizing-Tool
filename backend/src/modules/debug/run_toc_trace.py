...
# Allow running as a script: `python -m src.modules.debug.run_toc_trace`
...
if __name__ == "__main__":
    ...
    if len(pos) > 0:
        ...
        pdf = os.getenv("PDF_PATH", "src/modules/debug/pdf_files/input.pdf")
    ...
    if visualize:
        try:
            from src.modules.debug.visualizer import visualize_run
