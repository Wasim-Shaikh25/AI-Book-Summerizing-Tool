...
"""
Regression: fragment / DB persistence invariants for the bundled law_of_tort.pdf.
"""
...
def _max_page_from_lines(pdf_path: str) -> int:
    lines, _book_title = extract_pdf(pdf_path)
...
def test_no_missing_fragment_mapping_or_empty_fragments() -> None:
    result, _ = run_pipeline(_law_of_tort_pdf(), enable_logs=False)
