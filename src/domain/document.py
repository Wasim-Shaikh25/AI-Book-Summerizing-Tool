...
class FinalHeading:
    ...
    # LLM traceability (populated by hierarchy assigner)
...
class PipelineResult:
    """Output of the (mostly) deterministic pipeline.

    Notes:
    - This is the in-memory representation; persistence/export should read/write this.
