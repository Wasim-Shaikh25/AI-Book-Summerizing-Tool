...
- English only; no syllabus/admin filler.

**Why book-mode prose default:** Line-audit flagged pseudo-bullet paragraphs and meta filler; user confirmed simple English means plain language, not short sentences.
